var Sketch = function () {
  function e(e) {
    ...
    return u, u.className = "sketch", o ? e.autoresize = !1 : (e.container.appendChild(u), e.hasOwnProperty("autoresize") || (e.autoresize = l.autoresize), u.id = t), n(self, g), n(s, e), n(s, p), a(), e.autoresize && i(), w.push(s), s.autostart && setTimeout(s.start, 0), s
  }
  ...
  function a() {
    ...
    function a(e) {
      ...
      if (o.touches && o.touches.length) for (var r, c = o.touches.length - 1; c >= 0; c--) r = o.touches[c], r.x = r.pageX - u, r.y = r.pageY - i, n = A[c] || r, r.dx = r.x - n.x, r.dy = r.y - n.x, r.ox = n.x, r.oy = n.y, A[c] = t(r);
    ...
    function c(e) {
      if (e = a(e), e.touches.length) for (var n in A) e.touches[n] || delete A[n];
      else A = {};
  ...
  function i() {
    if (s.autoresize) {
      ...
      s.fullscreen ? (s.height = e.height = 360, s.width = e.width = document.documentElement.clientWidth) : (e.height = s.height, e.width = s.width), s.resize && s.resize()
    }
  }
  ...
  var s, r = 0,
    ...
    p = {
      ...
      running: !1,
      start: function () {
        s.running || (s.setup && !s.initialized && (s.autopause, s.setup()), s.initialized = !0, s.running = !0, s.now = Date.now(), u())
