            ...
            <div class="row" v-if="getUser.own">
              ...
              <div class="col-md-4">
                <div class="set_header">
                  <p class="tit">头像</p>
                  <img src="../../test/img/b.jpg" width="200px" height="200px">
                  <button class="btn btn-default col-xs-12" @click="toggleShow()">设置头像</button>
                  <com-setUpload field="img" @crop-success="cropSuccess" @crop-upload-success="cropUploadSuccess" @crop-upload-fail="cropUploadFail" v-model="show" :value="show" :width="200" :height="200" :url="url" :headers="headers">
                  </com-setUpload>
                </div>
              </div>
            </div>
...
export default {
  ...
  mounted() {
    ...
    this.url = (process.env.NODE_ENV === 'production')
      ? 'http://api.secretlove.top/user/header'
